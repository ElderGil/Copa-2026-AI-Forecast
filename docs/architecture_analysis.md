...
* **Viés por Volume de Partidas na Janela Recente**: Somar pontos e gols ponderados sem normalização favorece seleções que jogaram mais partidas ou calendários de preparação mais longos.
